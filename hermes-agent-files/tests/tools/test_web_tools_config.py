...
class TestCheckWebApiKey:
    ...
    def test_ddgs_search_backend_does_not_enable_extract_tool(self):
        with patch("tools.web_tools._load_web_config", return_value={
            "backend": "ddgs",
            "search_backend": "ddgs",
            "extract_backend": "",
            ...
            with patch("tools.web_tools._ddgs_package_importable", return_value=True):
                from tools.web_tools import check_web_api_key, check_web_extract_api_key
                assert check_web_api_key() is True
                assert check_web_extract_api_key() is False

    def test_explicit_extract_backend_enables_extract_tool(self):
        with patch("tools.web_tools._load_web_config", return_value={
            "backend": "ddgs",
            "search_backend": "ddgs",
            ...
            with patch.dict(os.environ, {"TAVILY_API_KEY": "tvly-test"}):
                ...
                assert check_web_extract_api_key() is True
